...
:::warning You should use a trusted certificate on your Proxmox node. See this guide for reference:
...
4. You now see a screen with the secrets. **Copy them now and store them.**
...
proxmox = {
  name         = "nuc"
  cluster_name = "nuc"
  endpoint     = "https://nuc.peekoff.com:8006"
  insecure     = false
  username     = "root"
