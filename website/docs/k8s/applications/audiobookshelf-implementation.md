...
- `/audiobooks` and `/podcasts` mount subdirectories from the shared `media-share` NFS volume at `audiobookshelf/audiobooks` and `audiobookshelf/podcasts` respectively
